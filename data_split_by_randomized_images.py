"""
split video files by randomization 
"""
import os
import random
import shutil
...
def main():
    """  
    Main function to split data with randomized distribution
    """
    data_folder = '/Users/81737/work/VisInspection/FrameUploads_Iteration2' # input image
    train_folder = '/Users/81737/work/VisInspection/model_train/train_folder_randomly_Iteration2'
    test_folder  = '/Users/81737/work/VisInspection/model_train/test_folder_randomly_Iteration2'
    valid_folder = '/Users/81737/work/VisInspection/model_train/valid_folder_randomly_Iteration2'
    ...
    save_images_csv(train_folder, train_paths, train_labels, "../rndm_train.csv")
    save_images_csv(test_folder, test_paths, test_labels, "../rndm_test.csv")
    save_images_csv(valid_folder, valid_paths, valid_labels, "../rndm_valid.csv")

    # compine them all into one csv file
    system("cat rndm_train.csv rndm_test.csv rndm_valid.csv > merge_rndm_Iteration2.csv")

    # rename the path to GCP bucket
    with open("./merge_rndm_Iteration2.csv", "r") as f1:
