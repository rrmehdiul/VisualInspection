"""
split video files by stratification 
"""
import os
import random
import shutil
...
def main():
    """  
    Main function to split data with stratified distribution
    """
    data_folder = '/Users/81737/work/VisInspection/FrameUploads_Iteration2' # input image
    train_folder = '/Users/81737/work/VisInspection/model_train/train_folder_stratify_Iteration2'
    test_folder  = '/Users/81737/work/VisInspection/model_train/test_folder_stratify_Iteration2'
    valid_folder = '/Users/81737/work/VisInspection/model_train/valid_folder_stratify_Iteration2'
    test_prop = 0.1  # test set part of total
    valid_prop = 0.1  # val set part of total
    ...
    for class_folder in class_folders:
        ...
        for subclass_folder in subclass_folders:
            ...
            image_paths.extend([(os.path.join(subclass_path, file),
                                 class_folder) for file in image_files])

    # Separate image paths and class labels
    paths, labels = zip(*image_paths)

    # Perform train, test, validation split
    train_paths, test_valid_paths, train_labels, test_valid_labels = \
        train_test_split(paths,
                         labels,
                         test_size=(test_prop + valid_prop),
                         random_state=random_seed,
                         stratify=labels)

    test_paths, valid_paths, test_labels, valid_labels = \
        train_test_split(test_valid_paths,
                         test_valid_labels,
    ...
    save_images_csv(train_folder, train_paths, train_labels, "../strat_train.csv")
    save_images_csv(test_folder, test_paths, test_labels, "../strat_test.csv")
    save_images_csv(valid_folder, valid_paths, valid_labels, "../strat_valid.csv")

    # compine them all into one csv file
    system("cat strat_train.csv strat_test.csv strat_valid.csv > merge_strat_Iteration2.csv")

    # rename the path to GCP bucket
    with open("./merge_strat_Iteration2.csv", "r") as f1:
    ...
    with open("./final_stratified_Iteration2.csv", "w") as f2:
        f2.write(data)
