...
train_folder = '/Users/81737/work/VisInspection/model_train/train_folder_stratify_Iteration2'  # train folder
test_folder  = '/Users/81737/work/VisInspection/model_train/test_folder_stratify_Iteration2'   # test folder
valid_folder = '/Users/81737/work/VisInspection/model_train/valid_folder_stratify_Iteration2'  # validation folder
...
save_images_csv(train_folder, train_paths, train_labels, "../stratify_train.csv")
save_images_csv(test_folder, test_paths, test_labels, "../stratify_test.csv")
save_images_csv(valid_folder, valid_paths, valid_labels, "../stratify_valid.csv")

# combine them all into one csv file
from os import system 
system("cat stratify_train.csv stratify_test.csv stratify_valid.csv > merge_stratify_Iteration2.csv")

# rename the path to GCP bucket
with open("./merge_stratify_Iteration2.csv", "r") as f1:
...
with open("./final_stratify_Iteration2.csv", "w") as f2:
    f2.write(data)
